...
if [ ! -d src/retos/$challenge_number ]; then
  ...
  echo -e "\e[32m ✓ Challenge $challenge_number directory created\e[0m"
else
  echo -e "\e[31m ✗ Challenge $challenge_number directory already exists\e[0m"
...
echo -e "\e[32m ✓ Challenge $challenge_number files created\e[0m"
...
if [ $create_js = "y" ]; then
  ...
  echo -e "\e[32m ✓ JavaScript file created\e[0m"
fi
